...
DE_filtered_deseq <- dplyr::filter(iix, Difference != "Not significant")
DE_filtered_deseq
annotation_col = data.frame(
  LeukemiaType =substr(colnames(raw_coutns),8,10))
...
pheatmap(raw_coutns[1:10000,],show_rownames=FALSE,show_colnames=FALSE,
         annotation_col = annotation_col,
         scale = "none",clustering_method="ward.D2",
         clustering_distance_cols="euclidean",width = 15,height = 15)
