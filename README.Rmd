...
The next section are the parameters, you can select `DESeq2` or `edge2`, to performance the analysis, if you hava a second group ont your sample information file you want to test the interacion between treatment, for example ~SEX + DIET you can select add that interacion, by default ~Deasy~ chose "none" interaction, in wother word It just considerate the the first treatment.
