...
That's how `DEasy` can help you to explore and analyze data from Differential gene expression experiments, if you want more information you can check the GitHub repository here: [DEasy GitHub]([DEasy!](https://posfer585.shinyapps.io/DEasy/)), also you can run this example using data from *tests* folder on GitHub. 
